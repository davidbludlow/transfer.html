...
CMD ["run", "--frozen", "--allow-net=0.0.0.0:8080,transfer-html-sidecar.transfer-html.workers.dev:443", "--allow-env=WS_NO_BUFFER_UTIL,WS_NO_UTF_8_VALIDATE,NODE_ENV,SIDECAR_URL,SIDECAR_TOKEN", "relay.ts"]
