...
Versioned Playwright tests for `transfer.html`. Lives outside the project root to keep `node_modules` and other Node-related cruft out of the auditable surface.
...
- `specs/transfer.spec.ts` — baseline + experimental coverage of the send/receive flow. Each test isolates itself in a fresh browser context.
